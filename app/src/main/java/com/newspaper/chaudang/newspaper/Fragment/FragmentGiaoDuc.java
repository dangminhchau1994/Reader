...
public class FragmentGiaoDuc extends ListFragment {

    View view;
    RequestQueue requestQueue;
    ThoiSuAdapter thoiSuAdapter;
    String urlThoiSu = "http://vnexpress.net/rss/giao-duc.rss";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_giaoduc, container, false);
