...
public class FragmentGiaiTri extends ListFragment {

    View view;
    RequestQueue requestQueue;
    ThoiSuAdapter thoiSuAdapter;
    String urlThoiSu = "http://vnexpress.net/rss/giai-tri.rss";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_giaitri, container, false);
